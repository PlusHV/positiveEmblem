...
"Flier Guidance 3"];
    ...
    //need to go through each name
    //if it exists, push corresponding id num
    //else, push the original name
    ...
    for(let x of t1) { 
      let w = x;
        ...
        Object.keys(skills.c).forEach((key, index) => { // go through the list
          if (skills.c[key].name === x){
            w = index;
          }
