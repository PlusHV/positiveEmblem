...
function calculateMidStat(level, rarity, growth, base, bvid, offset, orgBase){
	...
	//TODO 
	//if growth value is above 39 then an additonal growth vector is added on.
	//you'd have 39 which would always return 1 regardless of level
	//Then for anything above 39, you take another growth vector. So with a growth vector of 42, you would use growth vector 39 and 3
	//95 5 star with boon would reach 44a and a 95 4 star with boon would reach 41. Everything else would be <= 39
	//example winter dimtri or any character with at least a growth rate if 90 (boon brings it up to 95 which returns a growth value of 42)
